...
description: Bu rehber, kuruluşların açık kaynaklı projelere nasıl katkıda bulunabileceklerini anlamalarına yardımcı olmak ve neden katkı yapmalarının kendileri için faydalı olacağını anlatmak için tasarlanmıştır.
weight: 10
---
...
<img src="/images/organization_diagram_1.png" style="max-width: 750px;"/>
...
<img src="/images/organization_diagram_2.png" style="max-width: 450px; margin-bottom: 3rem;"/>
...
<img src="/images/organization_diagram_3.png" style="max-width: 750px;"/>
...
<img src="/images/organization_diagram_4.png" style="max-width: 750px;"/>
...
![](/images/organization_diagram_5.png)
...
Lisanslar hakkında daha fazla bilgi almak için, OpenTR'nin hazırladığı [lisans rehberlerine](/docs/introduction-to-open-source/open-source-licenses/) göz atabilirsiniz.

#### 3. NIH sendromundan kurtulun

[NIH sendromu](https://en.wikipedia.org/wiki/Not_invented_here) (Not Invented Here sendromu), bir kuruluşun dış kaynaklardan faydalanmak yerine, kendi iç kaynaklarını kullanmayı tercih etmesi durumudur. Bu durum, kuruluşların açık kaynak projelere katkı yapmalarını engelleyebilir.
...
- [OSPO](https://en.wikipedia.org/wiki/Open_Source_Program_Office) (Open Source Program Office) kurma
- [ISO 5230 OpenChain](https://en.wikipedia.org/wiki/ISO/IEC_5230) standardına hazır olma
